...
-- Fixes OT pay estimate for employees AND admin/HR.

-- 1) Employees can read own salary (optional if using RPC below)
...
-- 2) RPC: pay context for OT form (works for employee + admin)
...
SELECT 'OK — OT pay context RPC installed' AS step;
